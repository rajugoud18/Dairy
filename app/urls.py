...
urlpatterns = [
    ...
    # path('pluswishlist/',views.plus_wishlist,name='wishlist'),
...
admin.site.site_header = "SRG Dairy"
admin.site.site_title = "SRG Dairy"
admin.site.site_index_title = "welcome to SRG Dairy"